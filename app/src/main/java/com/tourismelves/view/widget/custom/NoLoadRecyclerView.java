...
public class NoLoadRecyclerView extends RecyclerView {
    public NoLoadRecyclerView(Context context) {
        this(context, null);
    }

    public NoLoadRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NoLoadRecyclerView(Context context, AttributeSet attrs, int defStyle) {

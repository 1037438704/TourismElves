package com.tourismelves.view.widget.recycler;
...
import com.tourismelves.view.adapter.DownloadingHolder;
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    DownloadingHolder viewHolder = (DownloadingHolder) getChildViewHolder(view);

...
public class PermissionUtil {
     ...
     * @return 是否已经获取权限，没有自动申请
     */
    public static boolean getClearAppCachePermissions(@NonNull Activity activity, int requestCode) {
        return requestPerssions(activity, requestCode, Manifest.permission.CLEAR_APP_CACHE);
    }
    ...
    public static boolean getCameraPermissions(@NonNull Activity activity, int requestCode) {
        return requestPerssions(activity, requestCode, Manifest.permission.CAMERA);
    }
    ...
    public static boolean getContactsPermissions(@NonNull Activity activity, int requestCode) {
        return requestPerssions(activity, requestCode, Manifest.permission.READ_CONTACTS, Manifest.permission.WRITE_CONTACTS);
    }
     ...
     * 是否拥有传入的所有权限
     */
    public static boolean hasPermissons(Context context, @NonNull String... permissions) {
        if (!needCheckPermission()) {
            return true;
        }
        for (String permission : permissions) {
    ...
    public static boolean hasPermissons(Activity context, @NonNull String... permissions) {
        if (!needCheckPermission()) {
            return true;
        }
        for (String permission : permissions) {

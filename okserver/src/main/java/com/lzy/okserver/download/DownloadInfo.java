...
public class DownloadInfo implements Comparable<DownloadInfo> {
    ...
    public void putListener(String s, DownloadListener listener) {
        listenerMap.put(s, listener);
        Log.i("listenerMap", "put: " + s + "_" + listener);
    }

    public DownloadListener getListener(String s) {
        Log.i("listenerMap", "get: " + s + "_" + listenerMap.get(s) + "_" + listenerMap.size());
        return listenerMap.get(s);
    }

...
public class DownloadManager {
     ...
     */
    public void addTask(String fileName, String taskTag, Serializable data, BaseRequest request, DownloadListener listener, boolean isRestart) {
        ...
        if (downloadInfo.getState() == DownloadManager.NONE ||
                ...
                (isRestart && downloadInfo.getState() == DownloadManager.FINISH)) {
            //构造即开始执行
    ...
    public void addTask(String fileName, final String taskTag, Serializable data, BaseRequest request, DownloadListener listener,
                        boolean isRestart, boolean isWifiDown, boolean isDownload) {
        DownloadInfo downloadInfo = getDownloadInfo(taskTag);
        if (downloadInfo == null) {
            if (TextUtils.isEmpty(request.getUrl())) {
                return;
